...
import { useSharedTextAssets } from '../composables'
...
export function getTextContents(el: BigeElementText): BigeElementText['contents'] {
  if (el.version) {
...
export async function convertTextContent(
  el: BigeElementText,
  isByWord = false,
